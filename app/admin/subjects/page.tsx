...
export default function AdminSubjectsPage() {
  ...
  const [editTarget, setEditTarget] = useState<SubjectEntity | null>(null)
  ...
  return (
    <div className="space-y-6">
      ...
      <SubjectTable
        ...
        isLoading={isLoadingSubjects}
        onRefresh={handleRefresh}
        onEdit={(subject: SubjectEntity) => {
          setEditTarget(subject)
          setIsCreateSubjectOpen(true)
        }}
        onAddNew={() => { setEditTarget(null); setIsCreateSubjectOpen(true); }}
      />
      ...
      <CreateSubjectDialog
        ...
        onClose={() => { setIsCreateSubjectOpen(false); setEditTarget(null); }}
        classesList={classes}
